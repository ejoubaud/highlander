  ...
  module MigrationFiles
    class AddBadges < Base
      ...
      def up
        ...
        Badge.create!(name: '1_ping_pong_victory', tag: 'One small step forward', description: 'First Ping Pong victory')
        Badge.create!(name: '1_ping_pong_loss', tag: "Well that's to be expected", description: 'First Ping Pong loss')
        Badge.create!(name: '10_ping_pong_victories', tag: 'Paddle master', description: '10 Ping Pong victories')
        Badge.create!(name: '100_ping_pong_victories', tag: 'Paddle master', description: '100 Ping Pong victories')

class UsersController < ApplicationController
  ...
  def user_params
    params[:user].permit(:name, :email, :bio, :github_account, :twitter_account, :instagram_account, :pager_duty_account, :envato_account, :lighthouse_account, :team_city_account, :send_leaderboard, :send_bounties)
  end
